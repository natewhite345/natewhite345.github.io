...
\href{https://www.linkedin.com/in/natetheadequate}{\color{ProcessBlue}{\faIcon{linkedin}}} \href{https://www.github.com/natetheadequate}{\color{ProcessBlue}{\faIcon{github}}}/natetheadequate\hfill 
\makebox[0pt][c]{\href{https://natetheadequate.github.io}{\color{ProcessBlue}{\faIcon{home}\ \ \ }}}
\textbf{\underline{\LARGE Nathaniel White}} \href{https://orcid.org/0009-0009-0589-4481}{\color{ProcessBlue}{\faIcon{orcid}}}\hfill 
...
\section{Education}
  ...
  \resumeItemListStart
  \resumeBullet{Formulated biological hypothesis from analyzing protein engineering data.}
  \resumeBullet{Developed internal web app to visualize and analyze protein structure and mutational data using Dash and Plotly.}
  \resumeItemListEnd
...
\resumeItemListEnd
  ...
  \resumeSubHeadingListStart
  \resumeSubItem{Tech}{
    \ctt{Javascript/Typescript}{Language of major project I authored at Nth Cycle (LUCAS). JavaScript is the first programming language I learned and the language I am most proficient in. I completed a third of my Software Development class in Typescript before the teams were reshuffled and I had to switch to Java.}, 
    ...
    \ctt{Java}{Two semesters of core CS classes taught in Java, and I completed 2/3 of my Software Dev class in Java. Would be very excited to work in Kotlin.}, 
