...
\end{tabularx}
  ...
  \resumeItemListStart
  \resumeBullet{Performed modernization and maintenance across over 80 SpringBoot applications.}
  \resumeBullet{Developed a workflow using OpenRewrite that halved the time spent on SpringBoot major version upgrades.}
  ...
  \resumeBullet{Developed automation using OpenRewrite, SonarQube CLI, and Github Copilot to fix code quality issues.}
