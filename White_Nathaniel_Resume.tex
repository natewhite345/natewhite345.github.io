...
\end{tabularx}
  ...
  \resumeSubheadingThin{Associate Software Engineer @ Fidelity Investments}{June 2025 -- Now}{Fund Operations Platform Maintenance}
  \resumeItemListStart
  \resumeBullet{Created a harness to quickly perform bulk maintenance actions across my team's 80+ SpringBoot applications.}
  \resumeBullet{Migrated end-of-life dependencies 90\% faster than the previous set of version updates by using OpenRewrite.}
  \resumeBullet{Expanded Cucumber end-to-end tests to be able to test applications requiring Active Directory authentication.}
  \resumeBullet{Developed automation using OpenRewrite, SonarQube CLI, and Github Copilot to fix code quality issues at scale.}
  \resumeBullet{Introduced use of OpenApi code generation to reduce development time and bugs.}
...
\resumeSubHeadingListStart
  ...
  \resumeSubItem{Tech}{
    ...
    \ctt{Java/SpringBoot}{Two semesters of core CS classes taught in Java, and I completed 2/3 of my Software Dev class in Java. Currently using SpringBoot at Fidelity.}, 
    ...
    \ctt{Bash/Linux}{Used in the Dong Lab extensively, and as part of my everyday life as a Linux user.},
    \ctt{Lean}{Undoubtedly the most esoteric language on this list, LEAN is a pure functional language similar to Rocq (formerly Coq) which is based on the Calculus of Inductive Constructions and dependent type theory. A fundamental conclusion of dependent type theory is the Curry-Howard correspondence, which equates theorems to functions and propositions to types. This means properties of programs can be formally verified, allowing for the development of high-assurance code, and one day maybe even practical use.},
...
\resumeSubheading{Programming Languages}{A course than ran after my graduation examining the PL design choices behind JS/TS.}{\href{https://felleisen.org/matthias/4400-f25/index.html}{\faIcon{link}}}{}{}
\resumeSubheading{Probability \& Statistics}{More advanced study of probability and stochastic processes grounded in measure theory}{\href{https://tropp.caltech.edu/notes/Tro24-Probability-Theory-LN.pdf}{\faIcon{link}}}{}{}
\resumeSubheading{Type Theory}{Learned some type theory from a textbook which uses Lean to make the theory more concrete.}{\href{https://raw.githubusercontent.com/blanchette/logical_verification_2023/main/hitchhikers_guide.pdf}{\faIcon{link}}}{}{}
